...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		MO(1), KC_LALT, KC_LGUI, KC_SPC, KC_ESC, KC_SPC, KC_RGUI, KC_RALT, KC_RCTL, XXXXXXX, XXXXXXX),
	...
	LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP, KC__MUTE, KC__VOLDOWN, KC__VOLUP),
